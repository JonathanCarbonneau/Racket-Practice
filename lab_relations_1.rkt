...
;; 3 PTS
(define (id n)
  (if (equal? n 1) (list (list 1 1)) (append (id (- n 1)) (list (list n n)))))
...
;; 3 PTS
(define (converse R)
  (if (null? R) '() (if (null? (cdr R)) (list (reverse (car R))) (append (list (reverse (car R))) (converse (cdr R))))))
...
;; 3 PTS
(define (relate x R)
  (if (null? R) '() (if (null? (cdr R)) (if (equal? x (car (car R))) (list (car (cdr (car R)))) '()) (if (equal? x (car (car R))) (append (list (car (cdr (car R)))) (relate x (cdr R))) (relate x (cdr R))))))
...
;; 3 PTS
(define (injective? R)
  (cond ((null? R) #t) ((null? (relate ( car (car (converse R ))) (cdr (converse R)))) (injective? (cdr R))) (else #f)))
#|-------------------------------------------------------------------------------|
