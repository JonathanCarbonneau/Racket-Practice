...
#|-------------------------------------------------------------------------------
 ...
 | Pledge:I pledge my honor that i have abided by the stevens honorsystem
 |-------------------------------------------------------------------------------|#
...
;; 1 PTS
(define (sign x)
  (cond ((positive? x)"positive") ((zero? x)"zero") ((negative? x)"negative") ))
...
;; 3 PTS
(define (subfact n)
  (cond ((= n 1) 0) ((= n 2) 1) ((and (> n 2) (even? n)) (+(* n  (subfact (- n 1))) 1)) ((and (> n 2) (odd? n)) (-(* n  (subfact (- n 1))) 1)) ))
...
(define (gen-fib a b n)
  (cond ((zero? n) a) ((= n 1) b) ((> n 1) (+ (gen-fib a b (- n 1))  (gen-fib a b (- n 2))) )))
